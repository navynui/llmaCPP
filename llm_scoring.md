...
| 9 | `Qwen3.6-14B-A3B-VibeForged-v2-Q4_K_M` | 39.8 | **17/25** | **11/18** | **14/18** | **3/15** | **13/14** | **3/10** | **🔹 61/100** |
...
| 5 | `Qwopus3.6-35B-A3B-v1-IQ4_XS` | **14** (33.2 t/s) | Near-complete, well-architected asyncio scraper with BeautifulSoup; hit 4096-token cap just before final output block | Excellent structured explanation of continuous batching with accurate comparison table for static vs paged memory | Deep reasoning shown in `<think>` chain but hit 4096-token limit before delivering a clean formatted answer | Hit 4096-token context limit mid-derivation in `<think>`; no final answer delivered despite correct intermediate math | Excellent hard-boiled cyberpunk story; precise BGP/LSP/OSPF details; strong isolation atmosphere; clean under 500-word delivery |
