...
| 2 | Qwen3.6-35B-A3B-UD-IQ3_S.gguf | IQ3_S (~17GB) | **32.8** t/s | Strong MoE reasoning, fast for size | ✅ HIGH PERFORMER |
| 3 | gemma-4-26B-A4B-it-APEX-GGUF | APEX Q4 (~13GB) | **18.0** t/s | Decent quality, acceptable speed | ⚠️ OK |
| 4 | gemma-4-26B-A4B-it-UD-IQ4_XS.gguf | IQ4_XS (~13.6GB) | **17.0** t/s | Similar to APEX, slightly slower | ⚠️ OK |
| 5 | Qwen3.6-28B-REAP20-A3B-Q4_K_M.gguf | Q4_K_M (~15GB) | **30.7** t/s | Solid dense MoE, balanced performance | ✅ RECOMMENDED |
| 6 | Qwen3.5-9B-Uncensored-HauhauCS-Aggressive-Q4_K_M.gguf | Q4_K_M (~5.5GB) | **29.4** t/s | Small model, fast but less capable | ⚠️ SMALL MODEL |
| 7 | Qwen2.5-Coder-32B (Q4_K_M) | Q4_K_M (~17-18GB) | **3.0** t/s ❌ | Too large for 16GB VRAM; CPU offload kills speed | 🔴 REJECT |
...
- **E4B variants (8GB class)** are the sweet spot for maximum speed (~35 t/s) while maintaining good intelligence.
